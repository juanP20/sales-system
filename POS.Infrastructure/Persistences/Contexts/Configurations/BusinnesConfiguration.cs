...
{
    public class BusinnesConfiguration : IEntityTypeConfiguration<Business>
    {
        public void Configure(EntityTypeBuilder<Business> builder)
        {
            builder.HasKey(e => e.BusinessId).HasName("PK__Business__F1EAA36E54A3BE9B");
            ...
            builder.HasOne(d => d.District).WithMany(p => p.Businesses)
                ...
                .HasConstraintName("FK__Business__Distri__07C12930");
        }
    }
}
